...
export default {
    ...
    legalDocs: {
        common: {
            lastUpdated: "آخر تحديث: 16 فبراير 2026",
        },

        privacy: {
            title: "سياسة الخصوصية",
            intro:
                "يجمع Gold Live البيانات ويستخدمها فقط عند الحاجة لتشغيل المنصة. نحن لا نبيع بياناتك الشخصية.",

            sections: {
                transparency: {
                    title: "1) ما البيانات التي نجمعها",
                    p1:
                        "قد نجمع معلومات الحساب (اسم المستخدم، البريد الإلكتروني، صورة الملف الشخصي) والمحتوى الذي ترسله (المحادثات، التعليقات، البث المباشر).",
                    p2:
                        "قد نجمع بيانات تقنية (عنوان IP، الجهاز، نظام التشغيل، السجلات) للحفاظ على استقرار التطبيق وأمانه.",
                    p3:
                        "قد نجمع بيانات المعاملات (سجل مشتريات العملات والماس والهدايا الافتراضية). نحن لا نجمع بيانات حساسة مثل القياسات الحيوية أو المعلومات الطبية أو الموقع الدقيق في الوقت الحقيقي.",
                },

                usage: {
                    title: "2) كيف نستخدم البيانات",
                    p1:
                        "نستخدم البيانات لتشغيل وصيانة البث المباشر، وتمكين تفاعل المستخدمين، ومعالجة المشتريات داخل التطبيق، ومنع الاحتيال وإساءة الاستخدام والنشاط غير القانوني.",
                    p2:
                        "لا نستخدم بياناتك للبيع أو المشاركة غير المناسبة.",
                },

                sharing: {
                    title: "3) المشاركة مع أطراف ثالثة",
                    p1:
                        "قد نشارك بيانات محدودة مع معالجي الدفع المعتمدين (Google Play Billing / Apple In-App Purchase) ومزودي الاستضافة والأمان والجهات القانونية عندما يفرض القانون ذلك.",
                    p2:
                        "يجب على جميع الأطراف الثالثة الالتزام بقواعد صارمة لحماية البيانات.",
                },

                iap: {
                    title: "4) المشتريات داخل التطبيق",
                    p1:
                        "يستخدم Gold Live الأنظمة الرسمية: Google Play Billing وApple In-App Purchases.",
                    p2:
                        "لا نخزن تفاصيل بطاقة الدفع كاملة على خوادمنا.",
                },

                analytics: {
                    title: "5) الإعلانات والتحليلات",
                    p1:
                        "قد يستخدم Gold Live أدوات تحليلية لتحسين تجربة المستخدم وأداء التطبيق.",
                    p2:
                        "هذه الأدوات لا تبيع البيانات الشخصية ومصممة لعدم تحديد هوية المستخدمين بشكل فردي.",
                },

                ugc: {
                    title: "6) المحتوى الذي ينشئه المستخدمون",
                    p1:
                        "المستخدمون مسؤولون عن المحتوى الذي ينشرونه. يوفر Gold Live أدوات للإبلاغ وقد يزيل المحتوى غير القانوني أو المسيء أو غير المناسب.",
                    p2:
                        "قد يتم تعليق الحسابات التي تنتهك الشروط أو إنهاؤها.",
                },

                children: {
                    title: "7) خصوصية الأطفال (18+ فقط)",
                    p1:
                        "Gold Live غير مخصص لأي شخص يقل عمره عن 18 عامًا.",
                    p2:
                        "لا نجمع بيانات من الأطفال عن قصد. قد تتم إزالة الحسابات التي يتم تحديدها على أنها تخص قاصرين.",
                    p3:
                        "نلتزم بحماية خصوصية الأطفال (بما في ذلك COPPA حيثما ينطبق).",
                },

                rights: {
                    title: "8) حقوقك",
                    p1:
                        "يمكنك طلب الوصول إلى بياناتك، وتصحيح/تحديث معلوماتك، وطلب حذف الحساب، أو سحب الموافقة حيثما ينطبق.",
                    p2:
                        "يمكن تقديم الطلبات عبر بريد الدعم الرسمي.",
                },

                retention: {
                    title: "9) الاحتفاظ بالبيانات والحذف",
                    p1:
                        "نحتفظ بالبيانات فقط للمدة اللازمة للمنصة وللمتطلبات القانونية.",
                    p2:
                        "بعد حذف الحساب، تتم إزالة البيانات أو جعلها مجهولة الهوية حيثما أمكن.",
                },

                changes: {
                    title: "10) التغييرات على هذه السياسة",
                    p1:
                        "قد نقوم بتحديث سياسة الخصوصية هذه في أي وقت. تسري التغييرات عند نشرها.",
                },

                contact: {
                    title: "11) التواصل",
                    p1:
                        "هاتف الدعم: +33-6498415115",
                    p2:
                        "goldlive@gmail.com",
                },
            },
        ...
        terms: {
            title: "شروط الخدمة",
            intro:
                "توضح هذه الشروط كيفية استخدام Gold Live. باستخدامك للتطبيق، فإنك توافق على اتباع هذه القواعد.",

            sections: {
                eligibility: {
                    title: "1) الأهلية",
                    p1:
                        "Gold Live مخصص للمستخدمين بعمر 18 عامًا فأكثر. إذا كنت أقل من 18 عامًا، يجب ألا تستخدم التطبيق.",
                },

                account: {
                    title: "2) حسابك",
                    p1:
                        "أنت مسؤول عن نشاط حسابك وعن الحفاظ على أمان بيانات تسجيل الدخول.",
                    p2:
                        "يجب أن تقدم معلومات دقيقة وألا تنتحل شخصية الآخرين.",
                },

                userContent: {
                    title: "3) المحتوى والسلوك",
                    p1:
                        "أنت مسؤول عن أي شيء تنشره أو تبثه أو تشاركه (بما في ذلك المحادثات والتعليقات).",
                    p2:
                        "لا يُسمح بالمحتوى غير القانوني أو المسيء أو غير المناسب. قد نزيل المحتوى ونتخذ إجراءات ضد الحسابات التي تنتهك القواعد.",
                },

                purchases: {
                    title: "4) العملات والهدايا والمشتريات",
                    p1:
                        "تتم معالجة المشتريات عبر Google Play Billing أو Apple In-App Purchase.",
                    p2:
                        "لا يخزن Gold Live تفاصيل بطاقة الدفع كاملة على خوادمه.",
                },

                enforcement: {
                    title: "5) التنفيذ",
                    p1:
                        "قد نقوم بتعليق الحسابات أو إنهائها إذا انتهكت هذه الشروط أو تسببت في خطر على المستخدمين أو المنصة.",
                    p2:
                        "قد نتعاون مع السلطات القانونية عندما يفرض القانون ذلك.",
                },

                changes: {
                    title: "6) التحديثات",
                    p1:
                        "قد نقوم بتحديث هذه الشروط. تسري التغييرات عند نشرها داخل التطبيق أو على صفحاتنا الرسمية.",
                },

                contact: {
                    title: "7) التواصل",
                    p1:
                        "إذا كانت لديك أسئلة، تواصل مع الدعم باستخدام التفاصيل الموجودة في صفحة سياسة الخصوصية.",
                },
            },
        },

        liveAgreement: {
            title: "اتفاقية البث المباشر",
            intro:
                "تنطبق هذه الاتفاقية عندما تستضيف أو تشارك في البث المباشر على Gold Live.",

            sections: {
                content: {
                    title: "1) قواعد محتوى البث المباشر",
                    p1:
                        "يجب ألا تبث محتوى غير قانوني أو مسيء أو غير مناسب. يجب أن تحترم المستخدمين الآخرين.",
                    p2:
                        "أنت مسؤول عن كل ما تعرضه أو تقوله أثناء البث المباشر.",
                },
                reporting: {
                    title: "2) الإبلاغ والإشراف",
                    p1:
                        "يوفر Gold Live أدوات للإبلاغ. قد نراجع البلاغات ونزيل المحتوى الذي يخالف القواعد.",
                },
                actions: {
                    title: "3) إجراءات الحساب",
                    p1:
                        "إذا خالفت القواعد، قد يتم تقييد بثك المباشر أو إزالة محتواك أو تعليق/إنهاء حسابك.",
                    p2:
                        "قد نتخذ إجراءات لمنع الاحتيال أو إساءة الاستخدام أو النشاط غير القانوني.",
                },
                age: {
                    title: "4) 18+ فقط",
                    p1:
                        "البث المباشر غير متاح لأي شخص يقل عمره عن 18 عامًا. قد تتم إزالة الحسابات التي يتم تحديدها على أنها تخص قاصرين.",
                },
            },
        },

        recharge: {
            title: "اتفاقية إعادة الشحن للمستخدم",
            intro:
                "توضح هذه الاتفاقية كيفية عمل مشتريات العملات/الماس والهدايا الافتراضية في Gold Live.",

            sections: {
                providers: {
                    title: "1) أنظمة الدفع الرسمية",
                    p1:
                        "تتم معالجة المشتريات عبر Google Play Billing وApple In-App Purchases.",
                },
                storage: {
                    title: "2) بيانات الدفع",
                    p1:
                        "لا يخزن Gold Live تفاصيل بطاقة الدفع كاملة على خوادمه.",
                },
                delivery: {
                    title: "3) سجلات الشراء",
                    p1:
                        "نحتفظ بسجلات سجل المشتريات (العملات، الماس، الهدايا) لتتبع الحساب والمعاملات.",
                },
                support: {
                    title: "4) الدعم",
                    p1:
                        "إذا واجهت مشاكل في الشراء، تواصل مع الدعم. يعتمد التعامل مع الاسترداد على قواعد متجر التطبيقات.",
                },
            },
        },

        childPolicy: {
            title: "سياسة عدم تعريض الأطفال للخطر",
            intro:
                "يلتزم Gold Live بحماية الأطفال. المنصة غير مخصصة للمستخدمين دون 18 عامًا.",

            sections: {
                age: {
                    title: "1) 18+ فقط",
                    p1:
                        "Gold Live ليس للقاصرين. إذا حددنا حسابًا يعود لقاصر، فقد نقوم بإزالته.",
                },
                noCollection: {
                    title: "2) عدم الجمع المتعمد",
                    p1:
                ...
                enforcement: {
                    title: "3) التنفيذ",
                    p1:
                        "قد نزيل المحتوى، ونعلّق البث، وننهي الحسابات المتورطة في تعريض الأطفال للخطر أو الاستغلال.",
                },
                reporting: {
                    title: "4) الإبلاغ",
                    p1:
                        "استخدم أدوات الإبلاغ داخل التطبيق للإبلاغ عن المحتوى الضار.",
                    p2:
                        "يمكنك أيضًا التواصل مع الدعم باستخدام تفاصيل الاتصال الرسمية في صفحة سياسة الخصوصية.",
                },
            },
        },
    },
